...
import org.wordpress.android.fluxc.store.WCProductStore.RemoteAddedProductTagsResponsePayload;
...
public enum WCProductAction implements IAction {
    ...
    @Action(payloadType = RemoteAddedProductTagsResponsePayload.class)
    ADDED_PRODUCT_TAGS
}
